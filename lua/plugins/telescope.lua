...
vim.api.nvim_set_hl(0, "TelescopePromptNormal", { bg = palette.mantle })
vim.api.nvim_set_hl(0, "TelescopePromptBorder", { bg = palette.mantle, fg = palette.mantle })
...
vim.api.nvim_set_hl(0, "TelescopePromptTitle", { bg = palette.green, fg = palette.base })
